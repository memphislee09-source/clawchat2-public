...
- current public release asset: `openclaw-0.2.5-play-release.apk`
- current public release SHA256: `69258095f6651462158a199c5c375ae81d957e6590ff3250c8956036a76e5cea`
- current development build version is now `0.2.5`
- the screenshot-aligned palette build is now the promoted release baseline for both private and public repositories
...
- 当前公开 release 资产：`openclaw-0.2.5-play-release.apk`
- 当前公开 release SHA256：`69258095f6651462158a199c5c375ae81d957e6590ff3250c8956036a76e5cea`
- 当前开发构建版本已提升到 `0.2.5`
- 当前按参考稿收口后的聊天配色版本现已成为私有仓库和公开仓库的共同发布基线
